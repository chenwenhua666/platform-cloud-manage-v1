export default {
  ...
  tips: {
    ...
    iframeGrant: 'User name and password are administrator account and password',
    ...
    resetPasswordSuccess: 'The selected user password reset has been reset to 123456a_',
  ...
  rules: {
    ...
    password: 'Please input 6-20 letters, numbers and underscores for password',
  ...
  common: {
    system: 'Education analysis and evaluation system',
    systemIntroduce: 'DataAcquisition-Processing-Analysis-Visualization',
    desc: {
      a: 'Provide source analysis',
      b: 'Provide trend analysis',
      c: 'Provide statistical report',
      d: 'Provide thermodynamic diagram analysis',
    ...
    randomMessage: {
      ...
      c: 'Tomorrow is another day, full of hope.Is not it? ',
      d: 'Happy every day (◕ᴗ◕✿)',
