<template>
  <el-dialog v-el-drag-dialog :close-on-click-modal="false" :title="title" :type="type" :visible.sync="isVisible" :width="width" top="50px" @dragDialog="handleDrag">
    <el-form ref="form" :model="attachment" :rules="rules" label-position="right" label-width="100px">
      ...
      <el-form-item label="文件" prop="fileLength">
        <fileUpload ref="fileRef" :accept-size="2*1024*1024" :auto-upload="false" :limit="5" @fileLengthVaild="fileLengthVaild" @setId="setIdAndSubmit">
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button plain type="primary" :disabled="disabled" @click="submitForm">{{ $t('common.confirm') }}</el-button>
    </div>
  </el-dialog>
</template>
<script>
